...
# Detect only specific classes.txt (e.g., class 0 and class 2)
python yolov8_region_counter.py --source "path/to/video.mp4" --classes.txt 0 2 --weights "path/to/yolov8m.pt"
