...
def run(
    ...
    Examples:
        ...
        Run with custom model and specific classes.txt
        >>> run(weights="yolo11s.pt", source="traffic.mp4", classes.txt=[0, 2, 3], device="0")
    """
    vid_frame_count = 0
...
def parse_opt() -> argparse.Namespace:
    ...
    parser.add_argument("--classes.txt", nargs="+", type=int, help="filter by class: --classes.txt 0, or --classes.txt 0 2 3")
