---
description: Explore the details of Ultralytics engine results including classes.txt like BaseTensor, Results, Boxes, Masks, Keypoints, Probs, and OBB to handle inference results efficiently.
