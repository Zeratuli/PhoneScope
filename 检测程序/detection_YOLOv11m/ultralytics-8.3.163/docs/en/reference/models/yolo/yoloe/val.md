---
description: Documentation for YOLOE validator classes.txt in Ultralytics, supporting both text and visual prompt embeddings for object detection and segmentation models.
