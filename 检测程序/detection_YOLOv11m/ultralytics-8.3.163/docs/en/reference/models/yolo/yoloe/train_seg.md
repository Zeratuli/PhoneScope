---
description: Documentation for YOLOE segmentation trainer classes.txt in Ultralytics, supporting different training approaches including standard training, linear probing, training from scratch, and visual prompt training.
