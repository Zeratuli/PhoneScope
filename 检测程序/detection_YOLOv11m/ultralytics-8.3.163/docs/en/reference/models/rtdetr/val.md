---
description: Explore the RTDETRValidator and RTDETRDataset classes.txt for real-time detection and tracking. Understand initialization, transformations, and post-processing.
