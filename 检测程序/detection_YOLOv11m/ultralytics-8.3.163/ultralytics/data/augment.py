...
class BaseMixTransform:
    ...
    def __call__(self, labels):
        ...
        Examples:
            ...
            >>> result = transform({"image": img, "bboxes": boxes, "cls": classes.txt})
        """
...
class Albumentations:
    ...
    def __init__(self, p=1.0):
        ...
        Examples:
            >>> transform = Albumentations(p=0.5)
            >>> augmented = transform(image=image, bboxes=bboxes, class_labels=classes.txt)
...
class Format:
    ...
    Methods:
        __call__: Format labels dictionary with image, classes.txt, bounding boxes, and optionally masks and keypoints.
...
class RandomLoadText:
    ...
    Methods:
        __call__: Process the input labels and return updated classes.txt and texts.
    ...
    def __call__(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        selects negative texts from the remaining classes.txt. It then updates the class indices to match the
