...
class BaseDataset(Dataset):
    ...
    Methods:
        ...
        update_labels: Update labels to include only specified classes.txt.
    ...
    def __init__(
        ...
        Args:
            ...
            classes (List[int], optional): List of included classes.txt.
            fraction (float): Fraction of dataset to utilize.
            channels (int): Number of channels in the images (1 for grayscale, 3 for RGB).
        """
        super().__init__()
    ...
    def update_labels(self, include_class: Optional[List[int]]) -> None:
        """
        Update labels to include only specified classes.txt.

        Args:
            include_class (List[int], optional): List of classes.txt to include. If None, all classes.txt are included.
        """
