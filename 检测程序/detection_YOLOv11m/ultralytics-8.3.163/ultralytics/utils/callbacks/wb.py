...
def _plot_curve(
    ...
    Args:
        ...
        y (np.ndarray): Corresponding data points for the y-axis with shape (C, N), where C is the number of classes.txt.
        names (list, optional): Names of the classes.txt corresponding to the y-axis data; length C.
