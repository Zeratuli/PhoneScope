...
class FastSAM(Model):
    ...
    Methods:
        ...
        task_map: Returns mapping of segment task to predictor and validator classes.txt.
    ...
    def task_map(self) -> Dict[str, Dict[str, Any]]:
        """Returns a dictionary mapping segment task to corresponding predictor and validator classes.txt."""
