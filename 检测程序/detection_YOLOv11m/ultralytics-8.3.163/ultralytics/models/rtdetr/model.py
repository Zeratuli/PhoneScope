...
class RTDETR(Model):
    ...
    Methods:
        task_map: Return a task map for RT-DETR, associating tasks with corresponding Ultralytics classes.txt.
    ...
    def task_map(self) -> dict:
        """
        Return a task map for RT-DETR, associating tasks with corresponding Ultralytics classes.txt.

        Returns:
            (dict): A dictionary mapping task names to Ultralytics task classes.txt for the RT-DETR model.
        """
        return {
            "detect": {
