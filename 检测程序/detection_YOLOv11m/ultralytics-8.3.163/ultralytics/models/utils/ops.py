...
class HungarianMatcher(nn.Module):
    ...
    Examples:
        ...
        >>> pred_scores = torch.rand(2, 100, 80)  # 80 classes.txt
...
def get_cdn_group(
    ...
    Args:
        ...
        num_classes (int): Total number of object classes.txt.
    ...
    Examples:
        ...
        ...     "gt_groups": [2, 1],
        ... }
        >>> class_embed = torch.rand(80, 256)  # 80 classes.txt, 256 embedding dim
