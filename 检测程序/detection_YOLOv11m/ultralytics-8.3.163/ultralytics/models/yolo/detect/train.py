...
class DetectionTrainer(BaseTrainer):
    ...
    Attributes:
        ...
        data (Dict): Dictionary containing dataset information including class names and number of classes.txt.
    ...
    def set_model_attributes(self):
        ...
        # self.args.cls *= self.data["nc"] / 80 * 3 / nl  # scale to classes.txt and layers
        # self.args.cls *= (self.args.imgsz / 640) ** 2 * 3 / nl  # scale to image size and layers
        self.model.nc = self.data["nc"]  # attach number of classes.txt to model
