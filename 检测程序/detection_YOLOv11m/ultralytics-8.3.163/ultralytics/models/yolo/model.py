...
class YOLO(Model):
    ...
    Methods:
        ...
        task_map: Map tasks to their corresponding model, trainer, validator, and predictor classes.txt.
    ...
    def task_map(self) -> Dict[str, Dict[str, Any]]:
        """Map head to model, trainer, validator, and predictor classes.txt."""
        return {
            "classify": {
...
class YOLOWorld(Model):
    ...
    without requiring training on specific classes.txt. It extends the YOLO architecture to support real-time
    ...
    Examples:
        ...
        Set custom classes.txt for detection
    ...
    @property
    def task_map(self) -> Dict[str, Dict[str, Any]]:
        """Map head to model, validator, and predictor classes.txt."""
        return {
            "detect": {
                "model": WorldModel,
                "validator": yolo.detect.DetectionValidator,
...
class YOLOE(Model):
    ...
    def set_classes(self, classes: List[str], embeddings) -> None:
        ...
        Args:
            classes (List[str]): A list of categories i.e. ["person"].
            embeddings (torch.Tensor): Embeddings corresponding to the classes.txt.
        """
        assert isinstance(self.model, YOLOEModel)
        ...
        **kwargs,
        ...
        if len(visual_prompts):
            ...
            assert len(visual_prompts["bboxes"]) == len(visual_prompts["cls"]), (
                f"Expected equal number of bounding boxes and classes.txt, but got {len(visual_prompts['bboxes'])} and "
