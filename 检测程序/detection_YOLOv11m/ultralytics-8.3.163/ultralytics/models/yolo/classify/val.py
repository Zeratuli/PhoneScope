...
class ClassificationValidator(BaseValidator):
    ...
    Attributes:
        ...
        confusion_matrix (ConfusionMatrix): Matrix to evaluate model performance across classes.txt.
    ...
    def get_desc(self) -> str:
        ...
        return ("%22s" + "%11s" * 2) % ("classes.txt", "top1_acc", "top5_acc")
    ...
    def update_metrics(self, preds: torch.Tensor, batch: Dict[str, Any]) -> None:
        ...
        Notes:
            ...
            prediction list for later evaluation. N is limited to the minimum of 5 and the number of classes.txt.
        """
    ...
    def plot_predictions(self, batch: Dict[str, Any], preds: torch.Tensor, ni: int) -> None:
        ...
        Examples:
            ...
            >>> preds = torch.rand(16, 10)  # 16 images, 10 classes.txt
