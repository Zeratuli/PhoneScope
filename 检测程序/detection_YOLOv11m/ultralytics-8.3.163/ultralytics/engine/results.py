...
"""
Ultralytics Results, Boxes and Masks classes.txt for handling inference results.
...
class Probs(BaseTensor):
    ...
    Attributes:
        ...
        top5 (List[int]): Indices of the top 5 classes.txt by probability.
        top1conf (torch.Tensor | numpy.ndarray): Confidence score of the top 1 class.
        top5conf (torch.Tensor | numpy.ndarray): Confidence scores of the top 5 classes.txt.
    ...
    def __init__(self, probs: Union[torch.Tensor, np.ndarray], orig_shape: Optional[Tuple[int, int]] = None) -> None:
        ...
        Args:
            ...
            orig_shape (tuple | None): The original image shape as (height, width). Not used in this class but kept
                for consistency with other result classes.txt.

        Attributes:
            data (torch.Tensor | np.ndarray): The raw tensor or array containing classification probabilities.
            top1 (int): Index of the top 1 class.
            top5 (List[int]): Indices of the top 5 classes.txt.
            top1conf (torch.Tensor | np.ndarray): Confidence of the top 1 class.
            top5conf (torch.Tensor | np.ndarray): Confidences of the top 5 classes.txt.
    ...
    def top5conf(self) -> Union[torch.Tensor, np.ndarray]:
        ...
        Returns:
            (torch.Tensor | numpy.ndarray): A tensor or array containing the confidence scores for the
                top 5 predicted classes.txt, sorted in descending order of probability.

        Examples:
            >>> results = model("image.jpg")
            >>> probs = results[0].probs
            >>> top5_conf = probs.top5conf
            >>> print(top5_conf)  # Prints confidence scores for top 5 classes.txt
        """
