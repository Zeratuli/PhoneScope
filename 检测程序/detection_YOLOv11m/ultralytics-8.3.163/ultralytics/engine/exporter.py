...
class Exporter:
    ...
    def _pipeline_coreml(self, model, weights_dir=None, prefix=colorstr("CoreML Pipeline:")):
        ...
        _, nc = out0_shape  # number of anchors, number of classes.txt
        ...
        model.output_description["confidence"] = 'Boxes × Class confidence (see user-defined metadata "classes.txt")'
...
class IOSDetectModel(torch.nn.Module):
    ...
    def __init__(self, model, im):
        ...
        self.model = model
        self.nc = len(model.names)  # number of classes.txt
        if w == h:
