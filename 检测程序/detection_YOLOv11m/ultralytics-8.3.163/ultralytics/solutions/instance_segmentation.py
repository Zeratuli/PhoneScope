...
class InstanceSegmentation(BaseSolution):
    ...
    Methods:
        ...
        extract_tracks: Extract tracks including bounding boxes, classes.txt, and masks from model predictions.
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Examples:
            ...
            >>> print(summary)
        """
        self.extract_tracks(im0)  # Extract tracks (bounding boxes, classes.txt, and masks)
        self.masks = getattr(self.tracks, "masks", None)

        # Iterate over detected classes.txt, track IDs, and segmentation masks
