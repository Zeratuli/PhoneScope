...
class Inference:
    ...
    Methods:
        ...
        configure: Configure the model and load selected classes.txt for inference.
    ...
    def configure(self) -> None:
        """Configure the model and load selected classes.txt for inference."""
        ...
        # Multiselect box with class names and get indices of selected classes.txt
